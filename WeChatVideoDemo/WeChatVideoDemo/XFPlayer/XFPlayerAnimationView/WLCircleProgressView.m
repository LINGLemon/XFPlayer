...
+ (WLCircleProgressView *)showIn:(UIView*)view
{
    ...
    WLCircleProgressView *progressView = [WLCircleProgressView viewWithFrame:CGRectMake(0, 0, ProgressViewDiameter, ProgressViewDiameter)
...
{
    WLCircleProgressView *progressView = nil;
    for (WLCircleProgressView *subView in view.subviews)
    {
        if ([subView isKindOfClass:[WLCircleProgressView class]])
        {
